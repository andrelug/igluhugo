...
1. Servidor (ex: localweb, goDaddy, Mediatemple)
1. Design (ex: 99designs)
1. Desenvolvimento (ex: Iglu Websites)
1. Plataformas / Plugins / Addons / Construtores (ex: Wix, Squarespace, Weebly)
1. Manutenção (ex: Iglu Websites)

Nem sempre é preciso pagar por todos e, no caso de plataformas, elas juntam a manutenção, servidores e o próprio design e desenvolvimento no seu preço final - que em geral é mais barato ou mesmo de graça.

<img src="images/uploads/2017/09/14/background.jpg" class=" forestry--none" style="float: none;">

Dessa forma, ao dizer que um site é grátis estamos normalmente nos referindo a colocar um tudo menos o domínio em um pacote que nos possibilita ter um espaço na web para adicionar conteúdos e informações.
...
De resto, comece pelo meio que terá a menor fricção e menor custo - que no caso melhor que de graça só alguém pagando para você fazer um site.
...
Eu recomendo essa solução apenas para quem ou já tem bastante velocidade na criação de sites do zero e é um site simples ou para quem está em busca de aprendizado na prática. Inclusive para esse segundo grupo eu recomendo esse [guia com alguns caminhos possíveis para se tornar um desenvolvedor em 2017](https://www.igluonline.com/como-se-tornar-um-desenvolvedor-web-em-2017/).
...
Nesse caso eu até tenho uma sugestão bacana. Você pode usar o serviço Netlify como seu servidor. Ele também é gratuito :) [O próprio site da Iglu está hospedado no Netlify.](https://www.igluonline.com/por-que-troquei-o-wordpress-pelo-gerador-de-websites-estaticos-hugo/)
...
Algo que é importante mencionar aqui é que apesar dessas plataformas serem gratuitas e você tem acesso a vários designs (em forma de templates ou temas) e plugins (funcionalidades extras como formulários), o melhores designs e plugins são pagos. É possível ter grande parte das funcionalidades de um site institucional ou pessoal simples? Sim! Mas eu já gosto de um layout mais bonito e acabo sempre comprando pelo menos um template para customizar meus sites no WordPress, por exemplo.
...
## 4- Construtores de website - nível molezinha

Chegamos na minha última recomendação para este artigo e uma que no início da minha carreira como desenvolvedor eu tinha um certo preconceito e hoje estou olhando cada vez mais com olhos positivos.
...
Mas o interessante é que essas empresas estão já olhando para esses problemas e buscando melhorar seus produtos. A Wix, por exemplo, me surpreendeu muito recentemente com suas opções de design e funcionalidades.
