...
Para adicionar um link para o e-mail no WordPress devemos seguir o mesmo processo descrito acima, mas o link será um pouco diferente.

O protocolo que vem antes de um link para e-mail é o **mailto:** seguido pelo e-mail desejado. Exemplo:
...
Para adicionar um link para o telefone no WordPress devemos seguir o mesmo processo descrito acima, mas o link será um pouco diferente.

O protocolo que vem antes de um link para e-mail é o **tel:** seguido pelo telefone desejado no seguinte formato: + \[código do país\] \[DDD\] [Número de telefone]. Exemplo:
...
Se você quiser criar um link normal, para o telefone ou para o e-mail em um widget o processo é um pouco diferente. Os widgets não possuem um editor rico para criar os links automaticamente. Precisamos utilizar códigos em HTML para fazer isso. Também é necessário utilizar o widget tipo &#8220;Texto&#8221;

Para criar um link em HTML basta utilizarmos o seguinte padrão:
