...
A principal diferença entre os templates e plugins do WordPress é que os templates lidam com a apresentação do site e os plugins com a funcionalidade.

Contudo, o mercado de templates ficou tão competitivo nos últimos anos que os templates começaram a vir cheio de funcionalidades e até com alguns plugins incorporados a eles.

Isso nem sempre é visto como algo tão bom pois se você quiser trocar o visual do seu site perderá também algumas de suas funcionalidades. Se um template utilizar, por exemplo, um tipo de post customizado (custom post type) ao trocá-lo você perderá esse tipo de post e provavelmente fará uma bagunça em seu site.
...
Iniciantes no WordPress muitas vezes não prestam atenção na velocidade e boas práticas de código ao escolher um template premium.

Assim como mencionei anteriormente, o ambiente de desenvolvimento de templates é bastante concorrido. Isso faz com que algumas vezes os desenvolvedores utilizem de soluções muitas vezes não muito seguras e otimizadas. Isso pode comprometer a segurança e velocidade do seu site.
...
Vale lembrar que a maior parte desses sites são em Inglês, mas mesmo as empresas de desenvolvimento brasileiras de templates criam esses temas em Inglês para esses sites.
